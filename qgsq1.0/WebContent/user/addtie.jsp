...
<html>
    ...
    <body>
		...
		<div class="col-md-12">
			<form  role="form"  id="checkForm" class="form-horizontal" action="${pageContext.request.contextPath }/topicServlet?method=add&&userid=${userBean.id}" method="post">
