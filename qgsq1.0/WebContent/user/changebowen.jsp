...
<html>
    ...
    <body>
		...
		<div class="col-md-12">
		<form  role="form"  id="checkForm" class="form-horizontal" action="${pageContext.request.contextPath }/articleServlet?method=change&&articleid=${aricleBean.id}&&username=${userBean.username}&&password=${userBean.password}" method="post">	
	    	<div class="form-group col-md-12">
	    		<div class="col-md-12">
	    		<label> 标题：</label>
	    		</div>
	    		<div class="col-md-12">
	    		<input type="text" class="form-control" name="title" value="${aricleBean.title }">
	    		</div>
	    	</div>
	    	<div class="form-group col-md-12" >
	    		<div class="col-md-12">
				...
				<div class="col-md-12" style="margin: 20px auto 40px;" align="center">
					<textarea name="intro" id="myEditor" value="${aricleBean.content }"></textarea>
				</div>
			</div>
			<div class="form-group col-md-12" >
				<div class="col-md-12">
				...
				<div class="col-md-12"  >
					<textarea  name="information" id="information"  value="${aricleBean.detail }" style="width: 100%;height: 100px;" onclick="document.getElementById('information').value=UE.getEditor('myEditor').getPlainTxt().substring(0, 100)+'...'">
					</textarea>
				</div>
			</div>
			<div class="form-group col-md-12">
