...
public class MyNoteListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c = helper.query_note(user_id);
            ...
            //适配器
            SimpleCursorAdapter adapter = new SimpleCursorAdapter(this, R.layout.activity_my_note_list, c, from, to, 0);
            //列表视图
