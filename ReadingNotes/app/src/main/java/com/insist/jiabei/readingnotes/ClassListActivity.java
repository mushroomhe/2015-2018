...
public class ClassListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(ClassListActivity.this, "书籍分类为空", Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            //适配器
            SimpleCursorAdapter adapter=new SimpleCursorAdapter(this,R.layout.activity_class_list,c,from,to,0);
            //列表视图
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    builder.setMessage("是否删除此书籍分类？").setNegativeButton("是",new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            //提示删除成功
                            Toast.makeText(ClassListActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
                            //查询
                            Cursor c=helper.query_bookClass();
                            String[] from={"_id","className"};
                            int[] to={R.id.bookClassId,R.id.bookClassName};
                            SimpleCursorAdapter adapter=new SimpleCursorAdapter(getApplicationContext(),R.layout.activity_class_list,c,from,to,0);
                            ListView listView=getListView();
                            listView.setAdapter(adapter);
                        }
