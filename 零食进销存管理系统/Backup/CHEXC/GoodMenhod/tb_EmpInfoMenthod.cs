...
namespace CHEXC.GoodMenhod
{
    public class tb_EmpInfoMenthod
    {
        ...
        #region 注册
        public int tb_EmpInfoRegister(tb_EmpInfo Empinfo)
        {
            int intFalg = 0;
            try
            {
                string str_Add = "insert into tb_EmpInfo (EmpId,EmpName,EmpLoginName,EmpLoginPwd,EmpPost,EmpFalg) values( ";
                str_Add += " '" + Empinfo.intEmpId + "','" + Empinfo.strEmpName + "','" + Empinfo.strEmpLoginName + "',";
                str_Add += " '" + Empinfo.strEmpLoginPwd + "',";
                str_Add += " '" + Empinfo.strEmpPost + "',";
        ...
        #region 查询(个人信息)
        public SqlDataReader tb_EmpInfoFind(string strObject)
        {
            int intCount = 0;
            string strSecar = null;
            ...
            try
            {
                strSecar = "select * from tb_EmpInfo where EmpLoginName='"+strObject+"'";
                /*switch (intFalg)
                {
                    case 1:
                        strSecar = "select * from tb_EmpInfo where EmpId= '" + strObject + "' and EmpFalg=0";
        ...
        #region 查询
        public int tb_EmpInfoFind(string strObject, string pwwd,string post,int intFalg)
        {
            int intCount = 0;
            string strSecar = null;
            ...
            try
            {
                ...
                {
                    case 1:
                     strSecar = "select * from tb_EmpInfo where EmpLoginName= '" + strObject + "' and EmpFalg=0 and EmpPost='"+post+"'";
                     break;
                    case 2:
                     strSecar = "select * from tb_EmpInfo where EmpLoginName= '" + strObject + "' and EmpFalg=0 and EmpLoginPwd='" + pwwd + "' and EmpPost='" + post + "'";
                        break;
                }
