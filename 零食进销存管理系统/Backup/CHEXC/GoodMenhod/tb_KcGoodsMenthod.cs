...
namespace CHEXC.GoodMenhod
{
     public  class tb_KcGoodsMenthod
    {
        ...
        SqlDataReader qlddr = null;
         ...
         //修改数量
         public int tb_KcGoodsUpdate1(string name,int kcnum)
         {
             int intFalg = 0;
             try
             {
                 string str_Add = "update tb_KcGoods set  ";
                 str_Add += "KcNum=" + kcnum + "";
                 str_Add += "where KcGoodsName ='" + name + "'";
         ...
         public SqlDataReader tb_ThGoodsFind1(string goodname)
         {
             ...
             try
             {
                 ...
                 strSecar = "select * from tb_KcGoods  where KcGoodsName ='" + goodname + "'";
